...
Your Helixbox wallet consists of two main components:
1. **Base EOA Wallet**: The owner wallet that controls your smart wallet
2. **Smart Wallet**: A Safe\{Wallet\} contract controlled by your base wallet
...
<details>
<summary>
### Exporting Smart Wallet Owner Private Key 
</summary>
