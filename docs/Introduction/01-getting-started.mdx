...
<details>
<summary>
## Why Passkey? Seamlessly login cross Device.
</summary>
...
1. **Setting Up Passkeys**
   - During account creation, at welcome panel you'll be prompted to ask for create a passkey
...
You've successfully created your Helixbox account and are ready to explore the world of DeFi.

### What's next?

- [Export Wallet](./02-export-walletr.mdx)
- [Backup & Recovery](./03-backup-and-recover.mdx)
- [Smart Wallet Owner Address](./04-smart-wallet-owner-address.mdx)
