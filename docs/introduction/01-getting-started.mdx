...
1. Access Helixbox via desktop or mobile browser at [helixbox.ai](https://helixbox.ai)
...
<Tabs>
  ...
  <TabItem value="google" label="Google Auth">
   a. Select **Continue with Google**.<br/>
   b. Choose a Google Account.<br/>
  </TabItem>
  <TabItem value="wallet" label="Wallet Connect">
   a. Select a wallet provider. <br/>
   b. Sign the approval message.<br/>
  </TabItem>
</Tabs>
...
<Tabs>
  <TabItem value="overview" label="From Overview Page">
    1. **Login**: Visit [https://helixbox.ai/overview](https://helixbox.ai/overview) using a desktop/mobile browser
    2. **Navigate to Overview**: Click the **Overview** tab in the navigation bar (Mobile: tap the list icon at the top-left).
    3. At the top of the page, next to the avatar, click the **copy icon** next to your alphanumeric wallet address starting with `0x` (e.g., `0x5AbFc6...ed004b`).

    ![Overview Address](../assets/getting_started/getting_started3.png)
  </TabItem>

  <TabItem value="receive" label="Using Receive Page">
    1. Click the **Receive** button on the overview page or directly visit [helixbox.ai/receive](http://helixbox.ai/receive) from a browser on your computer.
  ...
  <TabItem value="avatar" label="From Avatar Menu">
    1. **Login**: Visit [https://helixbox.ai/overview](https://helixbox.ai/overview) using a desktop/mobile browser
    2. In the navigation bar, click the **Avatar button**.
...
<details>
<summary>
## Why Passkeys? Seamlessly log in cross-device {#passkeys}
</summary>
...
1. **Setting Up Passkeys**
   - During account creation, at the welcome panel, you'll be prompted to create a passkey
