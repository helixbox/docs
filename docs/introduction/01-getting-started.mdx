...
1. Access HelixBox via desktop or mobile browser at [helix.box](https://helix.box)
...
<Tabs>
  <TabItem value="email" label="Email">
   a. Enter your email address and select **Submit**.
   b. Enter the verification code sent to your email.
  </TabItem>
  <TabItem value="google" label="Google Auth">
   a. Select **Continue with Google**.
   b. Choose a Google Account.
  </TabItem>
  <TabItem value="wallet" label="Wallet Connect">
   a. Select a wallet provider. 
   b. Sign the approval message.
  </TabItem>
</Tabs>
...
<Tabs>
  ...
  <TabItem value="receive" label="Using Receive Page">
    1. Click the **Receive** button on the overview page or directly visit [helix.box/receive](http://helix.box/receive) from a browser on your computer.
