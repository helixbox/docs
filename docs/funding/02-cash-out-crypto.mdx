...
<details>
  ...
  2. **Navigate to Send**: Click the **Send** button on the overview page, or go directly to [https://helixbox.ai/send](https://helixbox.ai/send).
...
:::warning Security Protocols
  - 🔒 Always verify:
    ...
    - HTTPS certificate (https://helixbox.ai).
